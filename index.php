        ...
        <div class="tour-info">
          ...
          <div class="icons ">
            <div class="icon-wrapper">
              <a href="destination.php" class="icon"><i class="fas fa-hiking"></i></a>
              <h3 class="h3 card-title">Adventure Tours</h3>
            </div>
            <p class="section-text">For Adrenaline Junkies</p>

            <div class="icon-wrapper">
              <a href="destination.php" class="icon"><i class="fas fa-swimmer"></i></a>
              <h3 class="h3 card-title">Swimming Pool</h3>
            </div>
            <p class="section-text">Relax and Unwind</p>

            <div class="icon-wrapper">
              <a href="destination.php" class="icon"><i class="fas fa-camera"></i></a>
